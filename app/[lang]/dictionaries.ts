...
export const dictionaries: Record<Locale, Dictionary> = {
  en: {
    ...
    home: {
      ...
      title: "I design and build software that feels credible on day one and scales with the business behind it.",
      subtitle:
    ...
    aboutPage: {
      kicker: "About",
      title: "I build products that need both technical structure and professional presentation.",
      intro:
      ...
      items: [
        {
          ...
          summary:
            "A service-oriented backend designed for operational clarity, robust APIs, and long-term maintainability.",
          stack: ["Java", "Spring Boot", "PostgreSQL", "REST API"],
          outcome: "Built to support expanding business logic and team growth without losing structure.",
        ...
        {
          name: "High-Traffic Data Workflow",
          category: "Scalable systems",
          summary:
            "A performance-focused platform layer for handling large request volumes, background processing, and evolving data models.",
          stack: ["Spring Boot", "PostgreSQL", "NoSQL", "Caching"],
          outcome: "Improved reliability and prepared the system for larger production workloads.",
          website: "https://hesr-office.ir",
          websiteLabel: "Project website",
          thumbnailLabel: "Urban planning office",
          thumbnailSrc: "/projects/hesr-office.png",
        },
        {
          ...
          summary:
            "A polished multilingual website built to communicate authority, clarity, and conversion readiness.",
          stack: ["Next.js", "TypeScript", "Responsive UI", "Content Strategy"],
          outcome: "Created a more premium first impression and stronger freelance positioning.",
          website: "#",
          websiteLabel: "Project website",
          thumbnailLabel: "Add project cover image",
        },
      ],
    },
    contactPage: {
      ...
      availability: "Currently open to freelance work and remote collaborations.",
      links: [
        {
          label: "Email",
    ...
    homeContact: {
      kicker: "Contact",
      title: "Need a developer who can build the system and represent the brand well?",
  ...
  fa: {
    ...
    home: {
      kicker: "Java، سیستم‌های مقیاس‌پذیر و تجربه‌های وب پریمیوم",
      title:
        "من نرم‌افزار و وب‌سایت‌هایی می‌سازم که از همان روز اول حرفه‌ای دیده شوند و همزمان برای رشد آینده آماده باشند.",
      subtitle:
        "به استارتاپ‌ها، تیم‌های محصول و برندهای جدی کمک می‌کنم تا سیستم‌های بک‌اند قابل اعتماد و وب‌سایت‌های حرفه‌ای با ارائه قوی و اجرای فنی دقیق داشته باشند.",
      primaryCta: "گفتگو درباره پروژه",
      secondaryCta: "مشاهده نمونه‌کارها",
      highlights: [
        "معماری Java و Spring Boot",
        "طراحی داده با PostgreSQL و NoSQL",
    ...
    aboutPage: {
      kicker: "درباره من",
      title: "من محصولاتی می‌سازم که هم به ساختار فنی درست نیاز دارند و هم به ارائه حرفه‌ای.",
      intro:
    ...
    projectsPage: {
      kicker: "پروژه‌ها",
      title: "نمونه‌هایی از کارهای من در بک‌اند، مقیاس‌پذیری و وب‌سایت‌های حرفه‌ای",
      intro:
      ...
      items: [
        {
          name: "پلتفرم سرویس سازمانی",
          category: "معماری بک‌اند",
          summary:
            "بک‌اندی مبتنی بر سرویس با تمرکز بر شفافیت عملیاتی، APIهای قوی و نگهداری‌پذیری بلندمدت.",
          stack: ["Java", "Spring Boot", "PostgreSQL", "REST API"],
          outcome: "طراحی شده برای رشد منطق کسب‌وکار و توسعه تیم بدون از دست رفتن ساختار.",
          website: "https://hesr-office.ir",
        ...
        {
          name: "جریان داده پرترافیک",
          category: "سیستم‌های مقیاس‌پذیر",
          summary:
            "لایه‌ای از پلتفرم با تمرکز بر کارایی برای پردازش حجم بالای درخواست‌ها، پردازش پس‌زمینه و مدل داده در حال رشد.",
          stack: ["Spring Boot", "PostgreSQL", "NoSQL", "Caching"],
          outcome: "پایداری بیشتر و آمادگی بهتر برای بار کاری سنگین در محیط واقعی.",
          website: "https://hesr-office.ir",
          websiteLabel: "وب‌سایت پروژه",
          thumbnailLabel: "دفتر شهرسازی",
          thumbnailSrc: "/projects/hesr-office.png",
        ...
        {
          name: "وب‌سایت برند شخصی پریمیوم",
          category: "طراحی و توسعه وب‌سایت",
          summary:
            "وب‌سایتی چندزبانه و حرفه‌ای برای انتقال حس اعتبار، شفافیت و آمادگی برای جذب پروژه.",
          stack: ["Next.js", "TypeScript", "Responsive UI", "Content Strategy"],
          outcome: "ایجاد اولین برداشت حرفه‌ای‌تر و جایگاه قوی‌تر برای فعالیت فریلنسری.",
          website: "#",
          websiteLabel: "وب‌سایت پروژه",
          thumbnailLabel: "محل تصویر پروژه",
        },
      ],
    },
    contactPage: {
      ...
      availability: "در حال حاضر برای همکاری فریلنسری و همکاری ریموت در دسترس هستم.",
      links: [
        {
          label: "ایمیل",
          href: sharedContacts.email,
    ...
    homeContact: {
      kicker: "ارتباط",
      title: "به توسعه‌دهنده‌ای نیاز دارید که هم سیستم را بسازد و هم برند را حرفه‌ای نمایش دهد؟",
